...
const Dashboard = ({ route }) => {
  ...
  // Calculate the chart width to fit inside the container with proper padding
  const chartWidth = Dimensions.get('window').width - 50; // Adjusted width
...
const styles = StyleSheet.create({
  ...
  chartSection: {
    ...
    borderRadius: 10,
    padding: 15,
    paddingRight: 10, // Reduced right padding to prevent chart overflow
    marginBottom: 20,
    shadowColor: '#000',
    shadowOpacity: 0.1,
    shadowRadius: 5,
  ...
  chart: {
    marginVertical: 8,
    borderRadius: 16,
    alignSelf: 'center', // Center the chart in its container
  },
  monthNavigation: {
    flexDirection: 'row',
    justifyContent: 'space-between',
