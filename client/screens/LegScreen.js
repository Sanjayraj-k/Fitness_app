...
const chestWorkouts = [
  { name: 'Squats', calories: 120 },
  { name: 'Lunges', calories: 110 },
  { name: 'Leg Press', calories: 100 },
  { name: 'Romanian Deadlifts', calories: 105 },
  { name: 'Step-Ups', calories: 115 },
];
  ...
  return (
    <LinearGradient colors={['#6e45e2', '#88d3ce']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>Leg Workouts</Text>
