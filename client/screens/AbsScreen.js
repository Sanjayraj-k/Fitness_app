...
const chestWorkouts = [
  { name: 'Crunches', calories: 60 },
  { name: 'Leg Raises', calories: 70 },
  { name: 'Plank', calories: 80 },
  { name: 'Bicycle Crunches', calories: 90 },
  { name: 'Mountain Climbers', calories: 100 },
];
  ...
  return (
    <LinearGradient colors={['#6e45e2', '#88d3ce']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>Abs Workouts</Text>
