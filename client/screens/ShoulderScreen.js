...
const chestWorkouts = [
  { name: 'Overhead Press', calories: 110 },
  { name: 'Lateral Raises', calories: 90 },
  { name: 'Rear Delt Flyes', calories: 90 },
  { name: 'Arnold Press', calories: 105 },
  { name: 'Dumbbell Shoulder Press', calories: 100 },
];
  ...
  return (
    <LinearGradient colors={['#6e45e2', '#88d3ce']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>Shoulder Workouts</Text>
