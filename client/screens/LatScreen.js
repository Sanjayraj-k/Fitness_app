...
const latWorkouts = [
  { name: 'Pull-Ups', calories: 100 },
  { name: 'Lat Pulldowns', calories: 95 },
  { name: 'Seated Rows', calories: 90 },
  { name: 'Bent-Over Rows', calories: 100 },
  { name: 'Straight Arm Pulldowns', calories: 85 },
];
  ...
  return (
    <LinearGradient colors={['#6e45e2', '#88d3ce']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>Lat Workouts</Text>
